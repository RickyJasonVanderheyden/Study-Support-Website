...
const AudioNotesView = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <div className="relative">
            <div className="w-12 h-12 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 animate-pulse shadow-lg shadow-indigo-100" />
  ...
  if (!audioNotes) {
    return (
      <div className="h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50 flex flex-col items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-indigo-100">
          ...
          <button 
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 shadow-md shadow-indigo-100 font-medium"
          >
            Go Back
          </button>
        </div>
  ...
  return (
    <div className={`h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50 flex flex-col overflow-hidden ${isResizing ? 'resizing' : ''}`}>
      <style>{customStyles}</style>
      
      {/* Header */}
      <header className="flex-shrink-0 bg-white/80 backdrop-blur-md border-b border-indigo-100 sticky top-0 z-50">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <button onClick={() => navigate('/module2')} className="text-sm font-medium text-indigo-600">Audio Notes</button>
            </nav>
            
            <div className="flex items-center gap-3">
              <button
                onClick={handleCopyScript}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-gray-500 hover:bg-indigo-50 hover:text-indigo-500 transition-all duration-200 text-sm"
              >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Left Sidebar */}
        <div className="w-72 flex-shrink-0 bg-white/70 backdrop-blur-md border-r border-indigo-100 flex flex-col overflow-y-auto hidden lg:flex">
          {/* Back Button */}
          <div className="p-4 border-b border-indigo-100">
            <button
              onClick={() => navigate('/module2')}
              className="flex items-center gap-2 text-gray-500 hover:text-indigo-600 text-sm transition-colors duration-200 group"
            >
            ...
            <div className="p-4 flex-1">
              ...
              <ul className="space-y-3">
                {audioNotes.keyPoints.map((point, i) => (
                  ...
                  >
                    <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-full flex items-center justify-center text-[11px] font-bold shadow-sm group-hover:scale-110 transition-transform duration-200">
                      {i + 1}
                    </span>
        ...
        <div className="flex-1 overflow-y-auto p-6 scroll-smooth">
          {!speechSupported ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center bg-white rounded-2xl p-8 shadow-lg border border-indigo-100">
                <AlertCircle className="w-12 h-12 mx-auto mb-3 text-indigo-300" />
                ...
                <motion.p
                  ...
                  className={`text-sm leading-relaxed p-4 rounded-xl cursor-pointer transition-all duration-300 ${
                    highlightedParagraph === index 
                      ? 'bg-gradient-to-r from-indigo-100 to-purple-50 text-gray-800 border-l-4 border-indigo-500 shadow-md transform scale-[1.01]' 
        ...
        <div 
          ...
          className="flex-shrink-0 bg-white/70 backdrop-blur-md border-l border-indigo-100 p-5 hidden lg:flex flex-col relative"
        >
          {/* Resize Handle */}
          <div
            onMouseDown={startResizing}
            className="absolute left-0 top-0 bottom-0 w-1 cursor-ew-resize group hover:bg-indigo-300 transition-colors flex items-center justify-center"
          >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-white border border-indigo-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all duration-200 cursor-pointer hover:border-indigo-300"
            >
              {voices.map((voice) => (
          ...
          <div className="mb-6">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-3 border border-indigo-100">
              <div className="flex justify-between items-center mb-2">
                <span className="text-2xl font-bold bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">{speechRate}x</span>
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded-lg text-xs font-medium transition-all duration-200 ${
                        speechRate === rate 
                          ...
                          : 'bg-white text-gray-500 hover:bg-indigo-100'
                      }`}
                    >
                      {rate}x
                    </button>
              ...
              <input
                ...
                className="w-full h-2 bg-white rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-gradient-to-r [&::-webkit-slider-thumb]:from-indigo-400 [&::-webkit-slider-thumb]:to-purple-500 [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:cursor-pointer"
              />
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col min-h-0 mb-4">
            ...
            <div className="flex-1 flex flex-col bg-gradient-to-br from-indigo-50 via-slate-50 to-purple-50 rounded-2xl p-4 border border-indigo-200 shadow-sm min-h-0">
              <div className="flex gap-2 mb-3">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-white border border-indigo-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent shadow-sm placeholder:text-gray-400"
                  disabled={aiLoading}
                />
                <button
                  onClick={handleAskAI}
                  disabled={aiLoading || !aiQuestion.trim()}
                  className="px-4 py-2.5 bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 rounded-xl text-white disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md"
                >
                ...
                <AnimatePresence mode="wait">
                  {aiAnswer ? (
                    <motion.div 
                      ...
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="p-3 bg-white rounded-xl border border-indigo-100 shadow-sm h-full"
                    >
                      <div className="flex items-start gap-2">
                        <div className="w-5 h-5 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-4 border border-indigo-100 shadow-sm">
            ...
            {isPlaying && !isPaused && (
              <div className="flex items-center justify-center gap-1 mb-4 h-6">
                {[...Array(12)].map((_, i) => (
                  <div 
                    key={i} 
                    className="w-1 bg-gradient-to-t from-indigo-400 to-purple-400 rounded-full wave-bar"
                    style={{ 
                      height: '100%',
            ...
            <div className="mb-4">
              <div 
                className="h-2 bg-white rounded-full overflow-hidden cursor-pointer shadow-inner group border border-indigo-50"
            ...
            <div className="flex items-center justify-center gap-3">
              <button 
                ...
                className="p-2 text-gray-400 hover:text-indigo-500 hover:bg-white rounded-lg transition-all duration-200"
                title="Restart"
              >
              ...
              <button
                onClick={handlePlay}
                className={`p-4 bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 rounded-full text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ${isPlaying && !isPaused ? 'playing-btn' : ''}`}
              >
      ...
      {/* Mobile Controls */}
      <div className="lg:hidden flex-shrink-0 bg-white/90 backdrop-blur-md border-t border-indigo-100 px-4 py-4">
        {/* Waveform */}
        {isPlaying && !isPaused && (
        ...
        <div className="flex items-center justify-center gap-6">
          <button onClick={handleSkipBack} className="p-2 text-gray-400 active:text-indigo-500 transition-colors">
            <SkipBack className="w-6 h-6" />
          </button>
          <button 
            onClick={handlePlay} 
            className={`p-4 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full text-white shadow-lg active:scale-95 transition-transform ${isPlaying && !isPaused ? 'playing-btn' : ''}`}
          >
            {isPlaying && !isPaused ? <Pause className="w-6 h-6" /> : <Play className="w-6 h-6 ml-0.5" />}
          </button>
          <button onClick={handleSkipForward} className="p-2 text-gray-400 active:text-indigo-500 transition-colors">
